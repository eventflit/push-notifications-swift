...
class PushNotificationsNetworkableTests: XCTestCase {
    ...
    let interest = "hello"
    let appId = "8a070eaa-033f-46d6-bb90-f4c15acc47e1"
    ...
    func testRegistration() {
        let url = URL(string: "https://\(appId).pushnotifications.eventflit.com/device_api/v1/instances/\(appId)/devices/apns")!
        ...
        networkService.register(deviceToken: deviceTokenData, appId: appId) { (deviceId, wasSuccessful) in
    ...
    func testSubscribe() {
        let url = URL(string: "https://\(appId).pushnotifications.eventflit.com/device_api/v1/instances/\(appId)/devices/apns/\(deviceId)/interests/\(interest)")!
    ...
    func testSetSubscriptions() {
        let url = URL(string: "https://\(appId).pushnotifications.eventflit.com/device_api/v1/instances/\(appId)/devices/apns/\(deviceId)/interests")!
    ...
    #if os(iOS)
    func testTrack() {
        let url = URL(string: "https://\(appId).pushnotifications.eventflit.com/reporting_api/v1/instances/\(appId)/events")!
        ...
        let networkService = NetworkService(url: url, session: URLSession.shared)
        let userInfo = ["data": ["eventflit": ["publishId": "1"]]]
    ...
    func testMetadata() {
        let url = URL(string: "https://\(appId).pushnotifications.eventflit.com/device_api/v1/instances/\(appId)/devices/apns/\(deviceId)/metadata")!
