...
extension Metadata: PropertyListReadable {
    ...
    func save() {
        ...
        userDefaults?.set(self.propertyListRepresentation(), forKey: "com.eventflit.sdk.metadata")
    }

    static func load() -> Dictionary<String, Any>? {
        let userDefaults = UserDefaults(suiteName: "PushNotifications")
        let metadata = userDefaults?.object(forKey: "com.eventflit.sdk.metadata") as? Dictionary<String, String>
